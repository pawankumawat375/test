              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p style="text-align: center;color: red;font-weight: 700;">{{ Session::get('error') }}</p>
                    @endif
                    @if (Session::has('seccess'))
                    <p style="text-align: center;color: rgb(0, 255, 85);font-weight: 700;">{{ Session::get('seccess') }}</p>
                    @endif
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{url('login')}}" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="pages-register.html">Create an account</a> or <a href="{{url('/')}}/forgotpassword">Forgot Password</a></p>
                    </div>
                  </form>
