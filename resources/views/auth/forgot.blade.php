              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your username & email to reset password</p>
                    @if (Session::has('error'))
                    <p style="text-align: center;color: red;font-weight: 700;">{{ Session::get('error') }}</p>
                    @endif
                  </div>

                  <form class="row g-3 needs-validation" method="POST" action="{{url('/')}}/forgotpassword" novalidate>
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0"> <a href="{{url('/')}}">Go To login Page </a> </p>
                    </div>
                  </form>
