...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link @if(Request::segment(2) == 'dashboard')activenew @endif" href="{{url('/')}}/admin/dashboard">
          <i class="bi bi-grid"></i>
          <span>Dashboard</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link @if(Request::segment(2) == 'admin')activenew @endif"" href="{{url('/')}}/admin/admin/list">
          <i class="bi bi-person"></i>
          <span>Admin</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link @if(Request::segment(2) == 'dashboard')activenew @endif" href="{{url('/')}}/teacher/dashboard">
          <i class="bi bi-grid"></i>
          <span>Dashboard </span> 
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link @if(Request::segment(2) == 'dashboard')activenew @endif" href="{{url('/')}}/student/dashboard">
          <i class="bi bi-grid"></i>
          <span>Dashboard</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link @if(Request::segment(2) == 'dashboard')activenew @endif" href="{{url('/')}}/parent/dashboard">
          <i class="bi bi-grid"></i>
          <span>Dashboard</span>
        </a>
      </li>
